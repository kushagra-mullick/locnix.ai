          ...
          <div className="container px-4 md:px-6">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
                Join thousands of students and educators who are already experiencing the benefits of AI-powered learning.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              />
              <Testimonial 
                quote="As a teacher, I can quickly generate customized flashcards for my students. The time savings alone are worth it, but the quality is amazing too."
                author="Mark T."
          ...
          <div className="container mx-auto text-center">
            <div className="glass-panel max-w-3xl mx-auto rounded-2xl p-12">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Button size="lg" variant="outline" className="rounded-full px-8 border-2" onClick={handleDemoRequest}>
                  Request Demo
                </Button>
              </div>
            </div>
